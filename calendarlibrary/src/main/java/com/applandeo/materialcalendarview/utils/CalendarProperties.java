...
public class CalendarProperties {
    ...
    private List<Calendar> mFilledDays = new ArrayList<>();
...
//        mSelectedDays.removeAll(disabledDays);
        ...
        mDisabledDays = Stream.of(disabledDays)
                .map(new Function<Calendar, Calendar>() {
                    @Override
    ...
    public void setFilledDays(List<Calendar> filledDays) {
//        mSelectedDays.removeAll(filledDays);

        mFilledDays = Stream.of(filledDays)
                .map(new Function<Calendar, Calendar>() {
                    @Override
                    public Calendar apply(Calendar calendar) {
                        DateUtils.setMidnight(calendar);
    ...
    public List<Calendar> getFilledDays() {
        return mFilledDays;
    }
