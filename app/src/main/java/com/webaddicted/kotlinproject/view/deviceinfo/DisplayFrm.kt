...
class DisplayFrm : BaseFragment() {
    ...
    private fun getDisplayInfo() {
        ...
        screenInfo = "<font color=\"#000000\">Screen Size : </font>${screenSizes}<br>"
        ...
        screenInfo += "<font color=\"#000000\">Physical Size : </font>${returnToDecimalPlaces(
            screenInches
        ...
        when (resources.configuration.orientation) {
            Configuration.ORIENTATION_PORTRAIT ->
                screenInfo += "<font color=\"#000000\">Default Orientation : </font>${resources.getString(
        ...
        screenInfo += "<font color=\"#000000\">Screen Width : </font>${pWidth.toString().plus(
            resources.getString(R.string.px)
        )}<br>"
        screenInfo += "<font color=\"#000000\">Screen Height : </font>${pHeight.toString().plus(
            resources.getString(R.string.px)
        )}<br>"
        /*** Screen refresh rate */
        screenInfo += "<font color=\"#000000\">Refresh Rate : </font>${display.refreshRate.toString().plus(
        ...
        when (resources.displayMetrics.density) {
            .75f ->
                displayInfo =
                    "<font color=\"#000000\">Display bucket : </font>${resources.getString(R.string.ldpi)}<br>"
            1.0f ->
                displayInfo =
                    "<font color=\"#000000\">Display bucket : </font>${resources.getString(R.string.mdpi)}<br>"
            1.5f ->
                displayInfo =
                    "<font color=\"#000000\">Display bucket : </font>${resources.getString(R.string.hdpi)}<br>"
            2.0f ->
                displayInfo =
                    "<font color=\"#000000\">Display bucket : </font>${resources.getString(R.string.xhdpi)}<br>"
            3.0f ->
                displayInfo =
                    "<font color=\"#000000\">Display bucket : </font>${resources.getString(R.string.xxhdpi)}<br>"
            4.0f ->
                displayInfo =
                    "<font color=\"#000000\">Display bucket : </font>${resources.getString(R.string.xxxhdpi)}<br>"
        }

        /*** Screen Dpi */
        displayInfo += "<font color=\"#000000\">Display dpi : </font>${resources.displayMetrics.densityDpi.toString().plus(
            resources.getString(R.string.dpi)
        )}<br>"
        /*** Screen xDpi and yDpi */
        displayInfo += "<font color=\"#000000\">XDpi : </font>${dm.xdpi.toString().plus(resources.getString(R.string.dpi))}<br>"
        displayInfo += "<font color=\"#000000\">YDpi : </font>${dm.ydpi.toString().plus(resources.getString(R.string.dpi))}<br>"
        /*** Screen logical density */
        displayInfo += "<font color=\"#000000\">Logical Density : </font>${dm.density}<br>"
        /*** Screen scaled density */
        displayInfo += "<font color=\"#000000\">Scaled Density : </font>${dm.scaledDensity}<br>"
        mBinding.txtDisplayInfo.setText(Html.fromHtml(displayInfo))

        /*** Screen usable width and height */
        val size = Point()
        display.getSize(size)
        resoluationInfo += "<font color=\"#000000\">Usable Width : </font>${size.x.toString().plus(resources.getString(R.string.px))}<br>"
        resoluationInfo += "<font color=\"#000000\">Usable Height : </font>${size.y.toString().plus(resources.getString(R.string.px))}<br>"

        /*** Screen density independent width and height */
        resoluationInfo += "<font color=\"#000000\">Display Independent Width : </font>${GlobalUtility.pxToDp(activity!!, dm.widthPixels).toString()
