...
import com.demo.kotlinproject.BR
import com.demo.kotlinproject.R
import com.demo.kotlinproject.data.api.pojo.Restaurants
import com.demo.kotlinproject.databinding.CategoriesRecyclerViewBinding
import com.demo.kotlinproject.databinding.RecyclerSingleBinding
...
class RecyclerAdapter1(
    ...
    fun bind(imageList: Array<Int>) = with(binding) {
        ...
        binding.categoryRecyclerView.layoutManager = LinearLayoutManager(binding.categoryRecyclerView.context,RecyclerView.HORIZONTAL,false)
